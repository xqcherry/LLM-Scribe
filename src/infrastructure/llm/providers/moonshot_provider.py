...
class MoonshotProvider:
    ...
    MODELS = {
        "moonshot-v1-8k": {"max_tokens": 8000, "cost_per_1k": 0.012, "max_output": 2048},
        "moonshot-v1-32k": {"max_tokens": 32000, "cost_per_1k": 0.024, "max_output": 4096},
        "moonshot-v1-128k": {"max_tokens": 128000, "cost_per_1k": 0.06, "max_output": 8192},
    }
    ...
    def __init__(self) -> None:
        ...
        self.api_key = (
            ...
            or getattr(self.config, "moonshot_api_key", "")
        )
    ...
    def create_model(
        ...
        if model_name is None:
            if prompt_tokens is not None:
                model_name = self.select_model(prompt_tokens)
            else:
                model_name = "moonshot-v1-32k"

        if max_tokens is None:
            max_tokens = self.MODELS[model_name]["max_output"]
